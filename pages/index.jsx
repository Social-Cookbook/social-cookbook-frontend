    ...
    <div>
		<div className="container flex flex-col">
			...
			<form className="container flex flex-col w-1/2 mx-10 mt-5" action="onSubmit">
				...
				<textarea className="drop-shadow-md rounded-lg h-32 p-2 mt-1" ref={desc} id="description" type="text" maxLength="250" placeholder="Max Characters: 250"></textarea>
				...
				<textarea className="drop-shadow-md rounded-lg h-32 p-2 mt-1" id="steps" ref={steps} type="text" placeholder="ex. Preheat oven./Mix dry ingredients."></textarea>
