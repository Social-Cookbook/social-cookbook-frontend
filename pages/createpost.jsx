...
export default function CreatePost() {
    ...
    const callUpload = async () => {
        ...
        const resp = await fetch('http://localhost:3000/api/recipe-posts/upload', fileUpload);
			...
			<form className="flex flex-col" action="onSubmit">
                <div className="flex flex-row m-5">
                    <div className="container flex flex-col p-10">
				        ...
				        <input className="mt-1" type="file" id="images" multiple ref={images} accept="image/*"></input>
                    ...
                    <div className="container flex flex-col py-10 pl-10">
                        <label for="steps" className="font-semibold">Steps</label>
				        <textarea className="drop-shadow-md rounded-lg h-44 p-2 mt-1 resize-none" id="steps" ref={steps} type="text" placeholder="ex. Preheat oven./Mix dry ingredients."></textarea>
